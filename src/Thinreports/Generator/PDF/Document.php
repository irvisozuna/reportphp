...
class Document
{
    ...
    public function __construct(Layout $default_layout = null)
    {
        ...
        $this->pdf->SetCreator('Irvis Ozuna');
        $this->pdf->SetAutoPageBreak(true,$default_layout->getMargin('B'));
        $this->pdf->SetMargins($default_layout->getMargin('L'), $default_layout->getMargin('T'), $default_layout->getMargin('R'), false);
        $this->pdf->SetCellPadding(0);
        $this->pdf->SetCellMargins(0, 0, 0, 0);
        $this->pdf->SetPrintHeader(false);
        $this->pdf->SetPrintFooter(true);
        $this->pdf->SetHeaderMargin($default_layout->getMargin('T'));
        $this->pdf->SetFooterMargin($default_layout->getMargin('B'));
