...
abstract class AbstractRenderer
{
    ...
    public function buildGraphicStyles(array $svg_attrs)
    {
        if (array_key_exists('stroke-opacity', $svg_attrs)
            ...
            $stroke_width = $svg_attrs['style']['border-width'];
        }
        if (!isset($svg_attrs["style"]['stroke-dasharray'])){
            $svg_attrs["style"]['stroke-dasharray'] = $svg_attrs["style"]['border-style'];
        }
        if ($svg_attrs["type"]=="line")
            $svg_attrs["style"]['fill-color'] = $svg_attrs["style"]['border-color'];
        return array(
            'stroke_color' => $svg_attrs["style"]['border-color'],
            'stroke_width' => $stroke_width,
            'stroke_dash'  => $svg_attrs["style"]['stroke-dasharray'],
            'fill_color'   => $svg_attrs["style"]['fill-color']
        );
    }
    ...
    public function buildTextStyles(array $svg_attrs)
    {
        return array(
            ...
            'font_style'     => $svg_attrs['font-style'],
            'color'          => $svg_attrs['color'],
            'align'          => $svg_attrs['text-align'],
            'letter_spacing' => $svg_attrs['letter-spacing']
        );
    }
